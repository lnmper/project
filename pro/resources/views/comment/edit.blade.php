...
@section('content')                   
    ...
    <!--这里加载的语言文件会覆盖你在配置项目里添加的语言类型，比如你在配置项目里配置的是英文，这里加载的中文，那最后就是中文-->
          ...
          <div class="mws-panel-body no-padding">
               <form class="mws-form" method="post" action="/admin/comment/update">
                    @if (count($errors) > 0)
                    ...
                    <div class="mws-form-inline">
                         <div class="mws-form-row">
                              ...
                              <div class="mws-form-item">
                                   <input  value="{{$user->username}}"type="text" name="username" class="small" >
                              </div>
                         </div>
                         <div class="mws-form-row">
                              <label class="mws-form-label">商品名称:</label>
                              <div class="mws-form-item">
                                   <input type="text" class="small" name="cname"value="{{$comments->cname}}">
                              </div>
                         </div>
                         ...
                         <div class="mws-form-row">
                              ...
                              <div class="mws-form-item">
                                  <script id='editor'type='text/plain'name="comment"style="width:600px;height:500px">{!!$comments->comment!!}@.{!!$user->username!!}</script>
                              </div>
                         </div>
                    ...
                    <div class="mws-button-row">
                         ...
                         <input type="submit" value="添加回复" class="btn btn-danger">
